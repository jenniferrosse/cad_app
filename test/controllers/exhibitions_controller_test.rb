...
class ExhibitionsControllerTest < ActionController::TestCase
  ...
  test "should create exhibition" do
    assert_difference('Exhibition.count') do
      post :create, exhibition: { description: @exhibition.description, end_date: @exhibition.end_date, start_date: @exhibition.start_date, title: @exhibition.title }
    end
  ...
  test "should update exhibition" do
    patch :update, id: @exhibition, exhibition: { description: @exhibition.description, end_date: @exhibition.end_date, start_date: @exhibition.start_date, title: @exhibition.title }
    assert_redirected_to exhibition_path(assigns(:exhibition))
  end
