class Exhibition < ActiveRecord::Base
  ...
  has_attached_file :exhibition_thumbnail, styles: { large: "1000x1000>", medium: "500x500>", square: "500x500>", small: "200x200>", thumb: "100x100>", tiny: "75x75>", }, convert_options: {square: " -gravity center -extent '500x500'", thumb: " -gravity center -extent '200x200'"}
