class GalleriesController < ApplicationController
  ...
  private
    ...
    def gallery_params
      params.require(:gallery).permit(:gallery_name, :address, :city, :state, :zip, :latitude, :longitude, :phone, :website, :email, :owner_operator, :medium, :description, :thumbnail, :hours, 
